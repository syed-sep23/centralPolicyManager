...
class PolicyRule(Base):
    ...
    version_id: Mapped[int] = mapped_column(
        ForeignKey("policy_versions.version_id"), nullable=False
    )
    ...
    subjects: Mapped[list[PolicyRuleSubject]] = relationship(
        "PolicyRuleSubject", back_populates="rule"
    )
    actions: Mapped[list[PolicyRuleAction]] = relationship(
        "PolicyRuleAction", back_populates="rule"
    )
    conditions: Mapped[list[PolicyRuleCondition]] = relationship(
        "PolicyRuleCondition", back_populates="rule"
    )
    resources: Mapped[list[PolicyRuleResource]] = relationship(
        "PolicyRuleResource", back_populates="rule"
    )
