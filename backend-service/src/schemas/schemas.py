...
# Types
PolicyStatus   = Literal["DRAFT","VALIDATED","FAILED_VALIDATION","DEPLOYING","ENFORCED","DEPRECATED","ROLLBACK"]
...
ActionType     = Literal["GRANT_SELECT","GRANT_INSERT","GRANT_UPDATE","DENY_ACCESS","MASK_COLUMN","FILTER_ROWS","AUDIT_LOG"]
MaskType       = Literal["NULL_MASK","HASH_SHA256","PARTIAL_MASK","EMAIL_MASK","PHONE_MASK","CUSTOM"]
AttributeType  = Literal["USER_ATTRIBUTE","RESOURCE_ATTRIBUTE","ENV_ATTRIBUTE","SESSION_ATTRIBUTE"]
Operator       = Literal["EQ","NEQ","IN","NOT_IN","GT","LT","GTE","LTE","CONTAINS","REGEX","IS_NULL","IS_NOT_NULL"]
